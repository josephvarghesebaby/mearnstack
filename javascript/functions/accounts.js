...
var creditTrasactions=accounts.map(data=>data.transactions).flat().filter(t=>t.to==1002)
var transactionHistory={"debitTransactions":debitTransactions,"creditTransactions":creditTrasactions}
console.log(transactionHistory);


var maxbal=accounts.sort((n1,n2)=>n2.balance-n1.balance);
console.log(maxbal);
