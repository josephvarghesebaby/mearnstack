  ...
  //currenncy, population, country name, capital
  for (let country of countries){
      let countryName=country.name;
      let population=country.population;
      let currencyName="Nan"
      let capital=country.capital;
      
      if ("currencyies" in countries){
        currencyName=country.currencies[0].name;
        newarray.push(currencyName);
}




let ctryData={countryName,population,currencyName,capital}// key assigning
  
newarray.push(ctryData);
}
//console.log(newarray);
//newarray.forEach(data=>console.log(data.countryName)); // for printing country names

//let indiaData=newarray.find(data=>data.countryName=="India") // for printing india details
//console.log(indiaData);


//china currency
//let chinacurrency=newarray.find(data=>data.countryName=="China")
...
//population above 20000000
var populationThreshholdAbove=countries.filter(data=>data.population>=20000000)
map(ctry=>ctry.countryName).forEach(name=>console.log(name));
